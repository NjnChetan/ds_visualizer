...
# from sorting_visualizer import open_sorting # This is not used by subprocess
from searching_visualizer import open_searching

# --- START OF FIX ---
# Get the absolute path to the directory this script (main.py) is in
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# Get the absolute path to the Python executable you are currently using
# This is safer than just "python"
...
def open_sorting():
    # Build the full, absolute path to the script
    script_path = os.path.join(BASE_DIR, "Algorithms", "Sorting_algoss.py")
...
def execute_linear_search():
    # Build the full, absolute path to the script
    script_path = os.path.join(BASE_DIR, "Algorithms", "linearsearch.py")
    # Run the script using the full path
    subprocess.run([PYTHON_EXECUTABLE, script_path])
...
def execute_binary_search():
    # Build the full, absolute path to the script
    script_path = os.path.join(BASE_DIR, "Algorithms", "binarysearch.py")
    # Run the script using the full path
    subprocess.run([PYTHON_EXECUTABLE, script_path])
